                ...
                <section className="container mx-auto px-6 py-20 md:py-32 text-center">
                    ...
                    <div className="flex flex-col md:flex-row gap-4 justify-center items-center">
                        <button
                            ...
                            className="px-8 py-4 bg-slate-900 text-white rounded-full font-bold text-lg hover:bg-slate-800 transition-all transform hover:scale-105 shadow-xl shadow-slate-900/10"
                        >
                            Start Auditing Now
                        </button>
                        <a
                            href="#features"
                            className="px-8 py-4 bg-white text-slate-700 border border-slate-200 backdrop-blur-sm rounded-full font-semibold text-lg hover:bg-slate-50 transition-all shadow-sm flex items-center justify-center"
                        >
                            View Documentation
                        </a>
                    </div>
