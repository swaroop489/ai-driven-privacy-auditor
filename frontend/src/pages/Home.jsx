            ...
            <div className="relative z-10">
                ...
                <header className="container mx-auto px-6 py-6 flex justify-between items-center">
                    ...
                    <div className="flex gap-4">
                        <button onClick={() => navigate('/login')} className="hidden md:block px-4 py-2 text-sm font-medium text-slate-600 hover:text-teal-600 transition-colors">Log In</button>
                        <button onClick={() => navigate('/upload')} className="px-5 py-2 text-sm font-medium bg-gradient-to-r from-teal-500 to-indigo-600 text-white rounded-full hover:shadow-lg hover:shadow-teal-500/25 transition-all transform hover:-translate-y-0.5">
                            Internal System
                        </button>
                    </div>
                </header>
